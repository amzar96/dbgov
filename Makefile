.PHONY: install dev lint format typecheck check validate validate-fix hooks clean run-plan run-apply docker-build docker-plan docker-apply test test-up test-down test-parser
